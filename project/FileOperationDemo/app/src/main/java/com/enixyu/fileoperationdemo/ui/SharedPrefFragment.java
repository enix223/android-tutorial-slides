...
public class SharedPrefFragment extends BaseIOFragment {

  public SharedPrefFragment(DataProvider mDataProvider) {
    super(mDataProvider);
  }
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    // 读取按钮
    Button readBtn = view.findViewById(R.id.btn_read_from_sp);
    ...
    // 写入按钮
    Button writeBtn = view.findViewById(R.id.btn_write_to_sp);
